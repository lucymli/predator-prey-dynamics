...
par <- c(r = 1, 	# intrinsic growth rate of prey
		...
		d1 = 0.099,		# death rate of Predator 1
		...
		i_n = 0.2,			#immigration rate of prey
...
write.csv(results,"/Users/lmq/Documents/IC/Final Year Project/Reports/Results/6. Immigration on same R stars/Data6b.csv")
