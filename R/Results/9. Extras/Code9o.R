...
matplot(out[ , 1], out[ , 2:4],type = "l", xlab = "Time", ylab = "Population size", lty=1,lwd = 2,col = c("Blue","Red","Purple"),cex.main=scaleText,cex.lab=scaleText,cex.axis=scaleText,ylim=c(0,10))
legend(x=35,y=5e+05, c("Prey", "Predator 1","Predator 2"), col = c("Blue","Red","Purple"), lty = 1,cex=scaleText)
...
legend(x=35,y=5e+05,c("Prey", "Predator 1"), col = c("Blue","Red"), lty = 1,cex=scaleText)
